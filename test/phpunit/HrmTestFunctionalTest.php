...
/**
 * \file    test/phpunit/HrmTestFunctionalTest.php
 * \ingroup hrmtest
 ...
 * @package Testhrmtest
 */
class HrmTestFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/hrmtest/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('hrmtest/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/hrmtest/admin/about.php');
		$this->authenticate();
		return $this->assertContains('hrmtest/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('hrmtestwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modHrmTest_HrmTestTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modHrmTest_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
