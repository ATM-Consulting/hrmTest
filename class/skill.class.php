...
class Skill extends CommonObject
{
	...
	public function getLinesArray()
	{
		...
		$result = $objectline->fetchAll('ASC', 'position', 0, 0, array('customsql'=>'fk_skill = '.$this->id));
...
/**
 * Class SkillLine. You can also remove this and generate a CRUD class for lines objects.
 */
class SkillLine extends CommonObjectLine
{
	// To complete with content of an object SkillLine
	// We should have a field rowid, fk_skill and position
